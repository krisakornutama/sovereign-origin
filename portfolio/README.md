...
เว็บโชว์ผลงานแบบ static หลายหน้า (`index.html` = ทัวร์ทั้งระบบ + `projects.html` = ผลงานทีละชิ้น/แนวคิด + `education.html` = โมดูล AI สอนลูก) — ไม่มี build step ไม่มี dependency โฮสต์ฟรีด้วย GitHub Pages
...
2. กด **uploading an existing file** แล้วลากไฟล์จากโฟลเดอร์ `portfolio/` **ทั้ง 5 ไฟล์** ขึ้นไป (`index.html`, `projects.html`, `education.html`, `.nojekyll`, `README.md`)
...
git init
git add index.html projects.html education.html .nojekyll README.md
