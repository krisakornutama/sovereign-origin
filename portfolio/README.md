...
2. กด **uploading an existing file** แล้วลากไฟล์จากโฟลเดอร์ `portfolio/` **ทั้ง 8 ไฟล์** ขึ้นไป (`index.html`, `projects.html`, `livestock.html`, `fishery.html`, `farm.html`, `education.html`, `.nojekyll`, `README.md`)
...
git init
git add index.html projects.html livestock.html fishery.html farm.html education.html .nojekyll README.md
