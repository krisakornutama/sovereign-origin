...
|---|---|---|---|
| 2026-09-17 ก่อนเปิดใช้ auto-deploy | — | krisakornutama | token ตัวปัจจุบัน — ตัดสินใจเมื่อ 2026-09-17 ให้**ใช้ต่อโดยไม่หมุน** |

> **การตัดสินใจ 2026-09-17:** เจ้าของเลือกใช้ token ตัวปัจจุบันต่อ (พิสูจน์ว่าแข็งแรงจาก deploy สำเร็จหลายรอบวันเดียวกัน)
> ค่า `PAGES_TOKEN_EXPIRES=2026-12-16` จึงเป็น **วันทบทวน** ไม่ใช่วันหมดอายุจริง: ถึงกำหนด (หรือเหลือ ≤14 วัน) watcher จะเปิด issue ให้ตัดสินใจ —
> จะหมุนจริงตาม §๒ หรือตั้งใจเลื่อนด้วยการแก้ตัวแปรเป็นวันใหม่ (การเลื่อนที่ตั้งใจ = ทางการ · การเมิน issue = watcher จะคอมเมนต์ต่อทุกสัปดาห์)
