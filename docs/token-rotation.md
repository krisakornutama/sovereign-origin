...
## ๓. ระบบเตือนในตัว (ทำไว้แล้วใน deploy-portfolio.yml)

- ตัวแปร `PAGES_TOKEN_EXPIRES` ถูกตั้ง → Preflight คำนวณวันคงเหลือทุกรอบ:
...
- **ไม่ได้ตั้งตัวแปร = ไม่มีการเตือนเลย** — เลยถือเป็นกติกา: ตอนสร้าง token ต้องตั้ง `PAGES_TOKEN_EXPIRES` เป็นขั้นตอนบังคับของ §๒
